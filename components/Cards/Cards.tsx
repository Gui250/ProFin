...
export default function Cards({ source, title, text }: Props) {
  return (
    <div className="p-4 font-outfit bg-[#FFFFFF] w-full max-w-[24rem] h-auto rounded-[1rem] transition-transform duration-300 ease-in-out hover:scale-105 will-change-transform cursor-pointer">
